...
if(!isset($_GET['name'])) $_GET['name'] = $_SESSION["MyIspindle0"]; else $_GET['name'] = $_GET['name'];
...
$(function () 
{
  ...
  { 
    ...
    chart = new Highcharts.Chart(
    {
      ...
      subtitle: 
      {
        text: 'Temperatur and Tilt last <?php echo $_GET['hours'];?>h'
      },
      xAxis: 
      {
	type: 'datetime',
	...
	crosshairs: [true, true],
	   ...
	   if(this.series.name == 'Temperatur') {
           	return '<b>'+ this.series.name +' </b> '+ Highcharts.dateFormat('%H:%M', new Date(this.x)) +' :  '+ this.y +'°C';
	   } else {
	   	return '<b>'+ this.series.name +' </b> '+ Highcharts.dateFormat('%H:%M', new Date(this.x)) +' :  '+ this.y +'°';
	   }
        }
      },  
      legend: 
...
<div id="wrapper">
  ...
  <center><div id="container" style="width:50%; height:30%; position:center"></div></center>
</div>
